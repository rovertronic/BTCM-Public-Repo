...
struct cmm_material cmm_mat_table[] = {
    ...
    {mat_maker_MakerHMazewall,     0, SURFACE_NOT_SLIPPERY, "Green Stone"},     // CMM_MAT_HMC_MAZEWALL
    ...
    {
        {
            ...
            {CMM_MAT_VP_RUSTYBLOCK, 0,                    "Rusted Block"},
...
u8 cmm_toolbox_vanilla[45] = {
    /*Tiles    */ CMM_BUTTON_TERRAIN, CMM_BUTTON_SLAB, CMM_BUTTON_SLOPE, CMM_BUTTON_CORNER, CMM_BUTTON_ICORNER, CMM_BUTTON_VSLAB, CMM_BUTTON_SSLOPE, CMM_BUTTON_TROLL, CMM_BUTTON_CULL,
    /*Tiles 2  */ CMM_BUTTON_WATER, CMM_BUTTON_FENCE, CMM_BUTTON_BARS, CMM_BUTTON_POLE, CMM_BUTTON_TREE, CMM_BUTTON_STAR, CMM_BUTTON_COIN, CMM_BUTTON_RCOIN,CMM_BUTTON_BCOIN,
    /*Items    */ CMM_BUTTON_VEXCLA, CMM_BUTTON_TC, CMM_BUTTON_GROUND,CMM_BUTTON_MECH, CMM_BUTTON_MPLAT, CMM_BUTTON_SPAWN, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK,
    /*Enemies  */ CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK,CMM_BUTTON_BLANK, CMM_BUTTON_BLANK,
    /*Obstacles*/ CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK, CMM_BUTTON_BLANK,CMM_BUTTON_BLANK, CMM_BUTTON_BLANK,
};
