...
s32 event_tl_intro[] = {
    //in box
    E_CAM_TOGGLE,
    E_CAM_POS_XYZ, -8979, -2608, 7418,
    E_CAM_FOCUS_XYZ, -8979, -2608, 7218,
    E_TARGET_OBJECT, bhvIntroBg,
    E_TARGET_OBJECT_ACTION, 1,
    E_WAIT, 20,
    ...
    E_TARGET_OBJECT_ACTION, 1,
    E_WAIT, 120,
    E_TARGET_OBJECT_ACTION, 0,
    E_WAIT, 30,
    E_DIALOG, DIALOG_TL_INTRO_1,
    E_WAIT, 60,
    E_CLOSE_DIALOG,
    E_WAIT, 30,
    E_REPEAT, 3,
    ...
    E_TARGET_OBJECT_ACTION, 0,
    E_WAIT, 20,
    E_DIALOG_AND_PRESSA, DIALOG_TL_INTRO_2,
    E_CLOSE_DIALOG,
    E_WAIT, 30,
    E_TARGET_OBJECT_ACTION, 1,
    E_WAIT, 10,
    ...
    E_DIALOG_AND_PRESSA, DIALOG_TL_INTRO_3,
    E_DIALOG_AND_PRESSA, DIALOG_TL_INTRO_4,
    E_DIALOG_AND_PRESSA, DIALOG_TL_INTRO_5,
    E_DIALOG_AND_PRESSA, DIALOG_TL_INTRO_6,
    E_DIALOG_AND_PRESSA, DIALOG_TL_INTRO_7,
    E_CLOSE_DIALOG,
    E_WAIT, 30,
    E_ZOUND, SOUND_GENERAL2_PURPLE_SWITCH,
    E_WAIT, 30,
    E_DIALOG_AND_PRESSA, DIALOG_TL_INTRO_8,
    E_CLOSE_DIALOG,
    E_ZOUND, SOUND_GENERAL2_PYRAMID_TOP_EXPLOSION,
    E_TARGET_OBJECT_ACTION, 3,
    E_WAIT, 25,
    E_TARGET_OBJECT_ACTION, 0,

    //black out
    E_CAM_POS_XYZ, -9179, -2608, 7418,
    E_CAM_FOCUS_XYZ, -9179, -2608, 7218,
    E_WAIT, 60,
    ...
    E_CAM_TOGGLE,
    E_SONG_TITLE, 2,
    E_MUSIC, SEQ_STREAMED_RUNOFF,

    E_PROGRESS_SET, PROG_TL_LEVEL1,

    E_END,
};

s32 event_watch_nearest_tv[] = {
    E_WAIT, 30,
    E_CAM_TOGGLE,
    E_TARGET_OBJECT, bhvMonitor,
    E_TARGET_OBJECT_ACTION, 1,
