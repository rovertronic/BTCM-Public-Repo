...
#define MODEL_FAST 0x125
#define MODEL_PINGAS 0x126
#define MODEL_CRABLET 0x127
#define MODEL_ESCALATOR 0x128
#define MODEL_TRAINCEIL 0x129
#define MODEL_CONNEX_1 0x12A
#define MODEL_CONNEX_2 0x12B
#define MODEL_KILLER_SPIKE 0x12C
#define MODEL_TROLLGATE 0x12D
#define MODEL_TROLLSTAIR 0x12E
#define MODEL_GLOBAL_CONE 0x12F
#define MODEL_SPRINGTRAP 0x130
#define MODEL_CRATETRAP 0x131
#define MODEL_QUARANTINE 0x132
#define MODEL_AXETRAP 0x133
#define MODEL_PILLAR_TROLL 0x134
#define MODEL_FORD 0x135
#define MODEL_BAROPE 0x136
#define MODEL_GHOSTFLOOR 0x137
#define MODEL_GHOSTFLOOR2 0x138
#define MODEL_VOIDLEAK 0x139
#define MODEL_CHECKPOINT_FLAG 0x1A0
#define MODEL_MONITOR 0x1A1
#define MODEL_TROLLSPAWN 0x1A2
#define MODEL_GLOBAL_PIPE 0x1A3
#define MODEL_CREEPIE_DOOR 0x1A4
#define MODEL_VOID_GOO 0x1A5
#define MODEL_TAXI 0x1A6
#define MODEL_INTROBG 0x1A7
#define MODEL_INTROSCAN 0x1A8
#define MODEL_HOVERWALL 0x1A9
#define MODEL_BRIDGEFALL 0x1AA
#define MODEL_COCKTUS 0x1AB
#define MODEL_COCKTUS2 0x1AC
#define MODEL_JUNKER 0x1AD
#define MODEL_DESERT_PILLAR 0x1AE
#define MODEL_BIGREDCOIN 0x1AF
#define MODEL_BURGER 0x1B0
#define MODEL_FENCEMEIN 0x1B1
#define MODEL_SWINGBOARD 0x1B2
#define MODEL_CREEPIE_FLOOR 0x1B3
#define MODEL_CRUSHER 0x1B4
#define MODEL_GLITCH 0x1B5
#define MODEL_EVILTHING 0x1B6
#define MODEL_OMNIWHEEL 0x1B7
