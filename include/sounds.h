...
#define SOUND_VO_FAST                            /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x40, 0xFE, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VO_PINGAS                          /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x41, 0xFE, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VO_FORD                            /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x42, 0xFE, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_DIE                                /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x43, 0xFE, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_NBODY1                             /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x44, 0xFE, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_NBODY2                             /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x45, 0xFE, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_XSCREAM                            /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x46, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_VID1                               /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x47, 0xFD, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VID2                               /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x48, 0xFD, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VID3                               /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x49, 0xFD, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VID4                               /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x4A, 0xFD, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VID5                               /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x4B, 0xFD, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VID6                               /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x4C, 0xFD, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VID7                               /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x4D, 0xFD, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_SHUT_UP_TV                         /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x4E, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_BOWSER_BOMB_EXPLOSION      /* 0x312F0080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x2F, 0xFF, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_RACE_GUN_SHOT              /* 0x314D4080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x4D, 0xFF, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_BLOG_1                             /* 0x30762080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x77, 0x20, SOUND_DISCRETE)
#define SOUND_BLOG_2                             /* 0x30762080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x78, 0x20, SOUND_DISCRETE)
#define SOUND_BLOG_3                             /* 0x30762080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x79, 0x20, SOUND_DISCRETE)
...
#define SOUND_CUSTOM_PEACH_POWER_OF_THE_STARS                     SOUND_ARG_LOAD(SOUND_BANK_ENV,      0x19, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_OBJ_BOO_LAUGH_LONG                 /* 0x50480080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x48, 0xFF, SOUND_DISCRETE)
...
#define SOUND_CUSTOM_PEACH_SOMETHING_SPECIAL                      SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x78, 0xFF, SOUND_DISCRETE)
...
#define SOUND_CUSTOM_PEACH_BAKE_A_CAKE                            SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x75, 0xFF, SOUND_DISCRETE)
