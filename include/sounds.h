...
#define SOUND_VO_FAST                            /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x40, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VO_PINGAS                          /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x41, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_VO_FORD                            /* 0x243FFF80 */ SOUND_ARG_LOAD(SOUND_BANK_VOICE,    0x42, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
