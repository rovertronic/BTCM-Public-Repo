...
const GeoLayout ccm_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_viscol_mesh_layer_4),
		GEO_CLOSE_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 2086, -108, -3037, 0, 90, 0, ccm_dl_visual_nolighting_mesh_layer_5),
		GEO_OPEN_NODE(),
