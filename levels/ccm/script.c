...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_GOOMBA, 10686, 2295, -16430, 0, -11, 0, 0x00000000, bhvGoomba),
		...
		OBJECT(MODEL_GOOMBA, 2710, 4598, -19223, 0, -87, 0, 0x00000000, bhvGoomba),
		...
		OBJECT(MODEL_NONE, 8812, 1270, -18930, 0, 0, 0, (10 << 24) | (TTRIG_GHOSTFLOOR << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 5801, 1270, -18930, 0, 0, 0, (11 << 24) | (TTRIG_GHOSTFLOOR << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 7376, 1270, -18930, 0, 0, 0, (10 << 24) | (TTRIG_GHOSTFLOOR << 16), bhvTrollTrigger),
		...
		OBJECT(MODEL_WHOMP, 10602, 2295, -17214, 0, 0, 0, 0x00000000, bhvSmallWhomp),
