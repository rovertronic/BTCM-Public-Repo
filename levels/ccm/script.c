...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, 4668, -860, -3734, 0, 0, 0, (6 << 24) | (TTRIG_CONNEX_FALL_1 << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 6870, 243, -3132, 0, 0, 0, (7 << 24) | (TTRIG_CONNEX_FALL_2 << 16), bhvTrollTrigger),
