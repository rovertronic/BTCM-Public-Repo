...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_AXETRAP, -2385, 2994, -8062, 0, 0, 0, (0 << 16), bhvAxeTrap),
		OBJECT(MODEL_AXETRAP, -1385, 2994, -8062, 0, 0, 0, (1 << 16), bhvAxeTrap),
		OBJECT(MODEL_AXETRAP, -385, 2994, -8062, 0, 0, 0, (0 << 16), bhvAxeTrap),
		...
		OBJECT(MODEL_SPRINGTRAP, -508, -860, 2057, 0, -90, 0, (0 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -808, -860, 1757, 0, -90, 0, (1 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -3208, -860, 1757, 0, -90, 0, (2 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -3808, -860, 1457, 0, -90, 0, (3 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -208, -860, 2957, 0, -90, 0, (4 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 392, -860, 2957, 0, -90, 0, (5 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 1292, -860, 2657, 0, -90, 0, (6 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3392, 1244, -4543, 0, 0, 0, (7 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 2492, 1244, -4543, 0, 0, 0, (8 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 2792, 1244, -4843, 0, 0, 0, (9 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -2308, -860, 1457, 0, -90, 0, (10 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -2908, -860, 2357, 0, -90, 0, (11 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 92, -860, 2357, 0, -90, 0, (12 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 2492, -860, 2057, 0, -90, 0, (13 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 2492, -860, 2957, 0, -90, 0, (14 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3392, -860, 2657, 0, -90, 0, (15 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3392, -860, 1457, 0, -90, 0, (16 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -508, -860, 1157, 0, -90, 0, (17 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -1708, -860, 1157, 0, -90, 0, (18 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -2908, -860, 1157, 0, -90, 0, (19 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 1892, -860, 1157, 0, -90, 0, (20 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3092, -860, 257, 0, 0, 0, (21 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3992, -860, -643, 0, 0, 0, (22 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 92, -860, 3257, 0, -90, 0, (23 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 392, -860, 3257, 0, -90, 0, (24 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 2192, -860, 3257, 0, -90, 0, (25 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -2908, -860, 3257, 0, -90, 0, (26 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -2908, -860, 3557, 0, -90, 0, (27 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3092, -860, 3857, 0, -90, 0, (28 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3992, -860, 3857, 0, -90, 0, (29 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 2492, 1244, -4243, 0, 0, 0, (30 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3092, 1244, -4243, 0, 90, 0, (31 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3392, 1244, -4243, 0, 90, 0, (32 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 2792, 1244, -4243, 0, 90, 0, (33 << 16), bhvSpringtrap),
		...
		OBJECT(MODEL_NONE, -1083, 3094, -8062, 0, 0, 0, (2 << 24) | (TTRIG_AXE << 16), bhvTrollTrigger),
	...
	AREA(2, ccm_area_2),
		...
		WARP_NODE(0x11/*END*/, LEVEL_CASTLE, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_SPRINGTRAP, -508, -860, 2657, 0, 90, 0, (34 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -5608, 2844, -5743, 0, -180, 0, (35 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -3508, 2844, -4843, 0, -90, 0, (36 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -7408, 2844, -5143, 0, -90, 0, (37 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -2908, -860, 3257, 0, -90, 0, (38 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -2908, -860, 3557, 0, -90, 0, (39 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, 3992, -860, 3857, 0, -90, 0, (40 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -7408, 2844, -4843, 0, -90, 0, (41 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -5308, 2844, -6043, 0, -180, 0, (42 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -5908, 2844, -6043, 0, -180, 0, (43 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -5608, 2844, -6343, 0, -180, 0, (44 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -6208, 2844, -5743, 0, -180, 0, (45 << 16), bhvSpringtrap),
		OBJECT(MODEL_SPRINGTRAP, -3508, 2844, -5143, 0, -90, 0, (46 << 16), bhvSpringtrap),
		OBJECT(0xFB, -8685, 3217, -5823, 0, 180, 0, 0x00000000, bhvBoneTrain),
		OBJECT(MODEL_TRAINCEIL, -8486, 4052, -6086, 0, 0, 0, 0x00000000, bhvTrainCeil),
		...
		OBJECT(MODEL_NONE, -4955, -1874, 2733, 0, 0, 0, (2 << 24) | (TTRIG_TROLL_STAIR << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, -4955, -1300, 2138, 0, 0, 0, (2 << 24) | (TTRIG_TROLL_STAIR << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 2912, 295, 1967, 0, 0, 0, (12 << 24) | (6 << 16) | (30), bhvBoxCheckpoint),
		OBJECT(MODEL_NONE, -3977, 3069, -4630, 0, 0, 0, (12 << 24) | (5 << 16) | (60), bhvBoxCheckpoint),
		OBJECT(MODEL_NONE, 984, -1310, 2152, 0, 0, 0, (6 << 24) | (TTRIG_PLANT << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 10652, 3074, -11726, 0, 0, 0, (8 << 24) | (4 << 16) | (90), bhvBoxCheckpoint),
