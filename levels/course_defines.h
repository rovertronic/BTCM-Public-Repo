...
DEFINE_COURSE(COURSE_WF, 0x10244440) // (2)  Whomp's Fortress
DEFINE_COURSE(COURSE_JRB, 0x44444440) // (3)  Jolly Rodger's Bay
DEFINE_COURSE(COURSE_CCM, 0x24144430) // (4)  Cool Cool Mountain
...
DEFINE_COURSE(COURSE_DDD, 0x40414430) // (9)  Dire Dire Docks
DEFINE_COURSE(COURSE_SL, 0x41022440) // (10) Snowman's Land
DEFINE_COURSE(COURSE_WDW, 0x24444440) // (11) Wet Dry World
DEFINE_COURSE(COURSE_TTM, 0x44444440) // (12) Tall Tall Mountain
DEFINE_COURSE(COURSE_THI, 0x04424440) // (13) Tiny Huge Island
DEFINE_COURSE(COURSE_TTC, 0x44444440) // (14) Tick Tock Clock
DEFINE_COURSE(COURSE_RR, 0x44444420) // (15) Rainbow Ride
DEFINE_COURSES_END()
