...
DEFINE_LEVEL("HOT", LEVEL_BOB, COURSE_BOB, bob, generic, 20000, 0x00, 0x00, 0x00, _, sCamBOB) 
...
DEFINE_LEVEL("CASCADE", LEVEL_JRB, COURSE_JRB, jrb, water, 20000, 0x00, 0x00, 0x00, _, sCamJRB) 
