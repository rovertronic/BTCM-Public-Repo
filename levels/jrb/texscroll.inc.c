...
void scroll_jrb_dl_bsmt_003_mesh_layer_1_vtx_4() {
	int i = 0;
	int count = 24;
	int width = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(jrb_dl_bsmt_003_mesh_layer_1_vtx_4);
...
void scroll_jrb() {
	...
	scroll_jrb_dl_bsmt_003_mesh_layer_1_vtx_4();
