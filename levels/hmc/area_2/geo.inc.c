...
const GeoLayout hmc_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, hmc_dl_lvl_003_mesh_layer_5),
			GEO_DISPLAY_LIST(LAYER_ALPHA, hmc_dl_lvl_003_mesh_layer_4),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout hmc_area_2[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 0, 0, 34727, 0, -100, 34727, geo_camera_main),
				GEO_OPEN_NODE(),
