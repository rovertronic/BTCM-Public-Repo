...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		WARP_NODE(0x0B/*CP1*/, LEVEL_HMC, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C/*CP2*/, LEVEL_HMC, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_CHECKPOINT_FLAG, 5411, 17756, 5776, 0, -180, 0, (2 << 16), bhvCheckpointFlag),
		...
		OBJECT(MODEL_COCKTUS, 8315, 15310, -1088, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_COCKTUS, 9148, 16276, -7745, 0, 0, 0, 0x00000000, bhvSmallBully),
		...
		OBJECT(MODEL_HOVERWALL, 5086, 18304, -3209, 0, 0, 0, (0 << 16), bhvHoverWall),
	...
	AREA(2, hmc_area_2),
		...
		WARP_NODE(0x0B/*CP1*/, LEVEL_HMC, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C/*CP2*/, LEVEL_HMC, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x30/*trollwarp*/, LEVEL_HMC, 0x02, 0x31, WARP_NO_CHECKPOINT),
		WARP_NODE(0x31/*trolldest*/, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_COCKTUS, 4295, 496, -1533, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_COCKTUS, 1306, 4297, -5534, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_COCKTUS, 3052, 9945, 326, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_COCKTUS, 2444, 9945, 326, 0, 0, 0, 0x00000000, bhvSmallBully),
		...
		OBJECT(MODEL_NONE, 3996, 253, -2093, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 1369, 29, 152, 0, 103, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 4674, 10643, 1011, 0, 85, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_RED_FLAME, 9763, 10546, 1320, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 9763, 12664, 1320, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 11128, 11853, 1320, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 11128, 13900, 1320, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 8515, 13906, 1875, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 8515, 13906, 732, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 7966, 10265, 1320, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_RED_FLAME, 6133, 10265, 1320, 0, 0, 0, 0x00000000, bhvFlame),
		OBJECT(MODEL_HEART, 9051, 13513, 1320, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(MODEL_HEART, 2117, 6095, -6612, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(MODEL_HEART, 4048, 6789, -6423, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(MODEL_HEART, 2863, 6164, -6828, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(MODEL_HOVERWALL, 9145, 1202, -459, 0, 0, 0, (0 << 16), bhvHoverWall),
		OBJECT(MODEL_HOVERWALL, 8581, 1202, 5541, 0, 0, 0, (1 << 16), bhvHoverWall),
		OBJECT(MODEL_HOVERWALL, 9145, 1202, 5541, 0, 0, 0, (0 << 16), bhvHoverWall),
		OBJECT(MODEL_HOVERWALL, 5086, 18304, -3209, 0, 0, 0, (0 << 16), bhvHoverWall),
		OBJECT(MODEL_JUNKER, -2227, 3643, -6662, 0, 0, 0, (2 << 16), bhvJunker),
		OBJECT(MODEL_MONITOR, 1671, 10194, -2388, 0, 90, 0, (4 << 16), bhvMonitor),
		OBJECT(MODEL_PILLAR_TROLL, 5411, 17756, 6474, 0, -180, 0, 0x00000000, bhvPillarTroll),
		OBJECT(MODEL_NONE, -3025, 5685, 11245, 0, 19, 0, (0x31 << 16), bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, 8836, 1146, 3934, 0, 0, 0, (5 << 24) | (TTRIG_NONE << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 8836, 1146, 5534, 0, 0, 0, (5 << 24) | (TTRIG_PANEL_FLIP << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 9226, 1305, -459, 0, 0, 0, (5 << 24) | (TTRIG_RUN_EARLY << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 5274, 17764, 3121, 0, 0, 0, (15 << 24) | (TTRIG_DIZZY << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, -1683, 128, -39, 0, 0, 0, (3 << 24) | (TTRIG_WINNER << 16), bhvTrollTrigger),
		OBJECT(MODEL_TROLLSPAWN, 5333, 18092, -585, 0, 0, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 5760, 18803, 2641, 0, 0, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 4491, 18267, 1978, 0, 0, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 2681, 10221, -2342, 0, 0, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, -223, 4402, -6629, 0, 0, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, -155, 5583, 12453, 0, -79, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 57, 5766, 13169, 0, -6, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 590, 5849, 13108, 0, -67, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 470, 5711, 13668, 0, -9, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 378, 5713, 12805, 0, -121, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 979, 5830, 13567, 0, -5, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, -7, 5636, 13703, 0, -58, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 597, 5709, 14241, 0, 44, 0, (2 << 16), bhvTrollSpawn),
		OBJECT(MODEL_TROLLSPAWN, 5579, 2263, 10779, 0, -94, 0, (3 << 16), bhvTrollSpawn),
		OBJECT(MODEL_NONE, -506, 4406, 1517, 0, 0, 0, (0x30 << 16), bhvWarp),
