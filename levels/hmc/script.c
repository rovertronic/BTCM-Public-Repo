...
const LevelScript level_hmc_entry[] = {
	...
	AREA(2, hmc_area_2),
		...
		WARP_NODE(0x0B/*CP1*/, LEVEL_HMC, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C/*CP2*/, LEVEL_HMC, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0D/*CP3*/, LEVEL_HMC, 0x02, 0x0D, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0E/*CP4*/, LEVEL_HMC, 0x02, 0x0E, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0F/*CP5*/, LEVEL_HMC, 0x02, 0x0F, WARP_NO_CHECKPOINT),
		WARP_NODE(0x10/*CP6*/, LEVEL_HMC, 0x02, 0x10, WARP_NO_CHECKPOINT),
		WARP_NODE(0x11/*winner*/, LEVEL_CASTLE, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x12/*CP8*/, LEVEL_HMC, 0x02, 0x12, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 6404, 17791, -7535, 0, 0, 0, (5 << 24) | (4 << 16) | (100), bhvBoxCheckpoint),
		OBJECT(MODEL_NONE, 4643, 11039, 1110, 0, 0, 0, (5 << 24) | (5 << 16) | (80), bhvBoxCheckpoint),
		OBJECT(MODEL_NONE, -1407, 4110, -6804, 0, 0, 0, (5 << 24) | (6 << 16) | (60), bhvBoxCheckpoint),
		OBJECT(MODEL_NONE, 8904, 971, 8550, 0, 0, 0, (5 << 24) | (8 << 16) | (30), bhvBoxCheckpoint),
		OBJECT(MODEL_COCKTUS, 4295, 496, -1533, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_COCKTUS, 1306, 4297, -5534, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_COCKTUS, 3052, 9945, 326, 0, 0, 0, 0x00000000, bhvSmallBully),
		OBJECT(MODEL_COCKTUS, 2444, 9945, 326, 0, 0, 0, 0x00000000, bhvSmallBully),
		...
		OBJECT(MODEL_NONE, 5411, 17756, 5696, 0, -179, 0, (0x0D << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 6612, 17562, -7385, 0, 70, 0, (0x0E << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 4447, 10617, 1263, 0, -95, 0, (0x0F << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, -1293, 3643, -6848, 0, -95, 0, (0x10 << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 8869, 695, 8540, 0, 177, 0, (0x12 << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 8836, 1146, 3934, 0, 0, 0, (5 << 24) | (TTRIG_NONE << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 8836, 1146, 5534, 0, 0, 0, (5 << 24) | (TTRIG_PANEL_FLIP << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 9226, 1305, -459, 0, 0, 0, (5 << 24) | (TTRIG_RUN_EARLY << 16), bhvTrollTrigger),
		OBJECT(MODEL_NONE, 5274, 17764, 3121, 0, 0, 0, (15 << 24) | (TTRIG_DIZZY << 16), bhvTrollTrigger),
