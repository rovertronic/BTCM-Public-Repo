...
extern void bhv_springtrap(void);
const BehaviorScript bhvSpringtrap[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oCollisionDistance, 500),
    SET_FLOAT(oDrawingDistance, 15000),
    LOAD_COLLISION_DATA(springtrap_collision),
    BEGIN_LOOP(),
...
const BehaviorScript bhvQuarantine[] = {
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_quarantine),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

extern void bhv_axe_trap();
const BehaviorScript bhvAxeTrap[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oDrawingDistance, 5000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_axe_trap),
    END_LOOP(),
};

extern void bhv_troll_pillar();
const BehaviorScript bhvPillarTroll[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oDrawingDistance, 10000),
    SET_HOME(),
...
const BehaviorScript bhvBigRedCoin[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_INT(oNumLootCoins, 5),
    // Whomp - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
...
extern void bhv_fencemein(void);
const BehaviorScript bhvFenceMeIn[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_FLOAT(oDrawingDistance, 20000),
    BEGIN_LOOP(),
